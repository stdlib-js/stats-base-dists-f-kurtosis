...
tape( 'if provided `d2 <= 8`, the function returns `NaN`', opts, function test( t ) {
	var y;
...
/*
tape( 'the function returns the excess kurtosis of an F distribution', opts, function test( t ) {
	var expected;
	var delta;
	var tol;
	var d1;
